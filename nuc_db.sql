...
--
-- Host: 127.0.0.1    Database: nuc_db
-- ------------------------------------------------------
...
CREATE TABLE `chassis` (
  ...
  `RaspLed` varchar(16) DEFAULT NULL,
...
INSERT INTO `chassis` VALUES (1,'172.16.0.109',4,'172.16.3.80','172.16.0.109'),(2,'172.16.0.17',4,'172.16.3.80','172.16.0.17'),(3,'172.16.3.2',2,'172.16.3.4','172.16.3.3');
...
CREATE TABLE `options` (
  ...
  `Unite` text,
  `infini` tinyint(1) DEFAULT NULL,
  `changed` tinyint(1) DEFAULT NULL,
  `Chassis` float(8,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `options` VALUES (55,1,92.00,60.00,'h',0,0,1.00),(79,1,92.00,60.00,'h',0,0,2.00),(80,0,0.00,60.00,'h',0,0,3.00);
...
-- Dump completed on 2024-05-07 11:19:32
